...
for filepath in glob.glob('/Users/adeningwerson/Desktop/Tennis-Landing-Page/blog/*.html'):
    ...
    # Replace the whole <aside class="sidebar"> block
    updated_content = re.sub(r'<!-- Monetization Sidebar -->\s*<aside class="sidebar">.*?</aside>', new_sidebar, content, flags=re.DOTALL)
